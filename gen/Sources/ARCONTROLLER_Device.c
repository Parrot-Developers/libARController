...
eARCONTROLLER_ERROR ARCONTROLLER_Device_RegisterCallbacks (ARCONTROLLER_Device_t *deviceController, void* specificFeature)
{
    ...
    if ((deviceController->follow_me != NULL) && ((specificFeature == NULL) || (specificFeature == deviceController->follow_me)))
    {
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_AVAILABILITY, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_RUN, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_GEOGRAPHICCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_RELATIVECONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_ANIMRUN, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_SPIRALANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_SWINGANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_BOOMERANGANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_CANDLEANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_DOLLYSLIDEANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
        
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_FollowMe_AddCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_USERFRAMINGPOSITIONCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
    ...
    if ((deviceController->miniDrone != NULL) && ((specificFeature == NULL) || (specificFeature == deviceController->miniDrone)))
    {
        ...
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_MiniDrone_AddCallback (deviceController->miniDrone, ARCONTROLLER_DICTIONARY_KEY_MINIDRONE_MASSSTORAGEMEDIASTATE_NBPHOTOSCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
...
eARCONTROLLER_ERROR ARCONTROLLER_Device_UnregisterCallbacks (ARCONTROLLER_Device_t *deviceController, void *specificFeature)
{
    ...
    if (error == ARCONTROLLER_OK)
    {
        ...
        if ((deviceController->follow_me != NULL) && ((specificFeature == NULL) || (specificFeature == deviceController->follow_me)))
        {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_RUN, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_GEOGRAPHICCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_RELATIVECONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_ANIMRUN, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_SPIRALANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_SWINGANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_BOOMERANGANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_CANDLEANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_DOLLYSLIDEANIMCONFIGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
            ...
            removingError = ARCONTROLLER_FEATURE_FollowMe_RemoveCallback (deviceController->follow_me, ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_USERFRAMINGPOSITIONCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
        ...
        if ((deviceController->miniDrone != NULL) && ((specificFeature == NULL) || (specificFeature == deviceController->miniDrone)))
        {
            ...
            removingError = ARCONTROLLER_FEATURE_MiniDrone_RemoveCallback (deviceController->miniDrone, ARCONTROLLER_DICTIONARY_KEY_MINIDRONE_MASSSTORAGEMEDIASTATE_NBPHOTOSCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring removing of the callback for ARCONTROLLER_DICTIONARY_KEY_MINIDRONE_MASSSTORAGEMEDIASTATE_NBPHOTOSCHANGED; error :%s", ARCONTROLLER_Error_ToString (removingError));
            }
...
eARCONTROLLER_ERROR ARCONTROLLER_Device_SetNetworkControllerToFeatures (ARCONTROLLER_Device_t *deviceController)
{
    ...
    if (error == ARCONTROLLER_OK)
    {
        ...
        {
            settingError = ARCONTROLLER_FEATURE_FollowMe_SetNetworkController (deviceController->follow_me, deviceController->privatePart->networkController);
            if (error != ARCONTROLLER_OK)
            {
