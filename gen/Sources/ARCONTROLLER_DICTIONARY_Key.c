...
eARCONTROLLER_DICTIONARY_KEY ARCONTROLLER_DICTIONARY_Key_GetFeatureFromCommandKey (eARCONTROLLER_DICTIONARY_KEY commandKey)
{
    ...
    if (ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLER <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLERDEBUG)
    {
        featrueKey = ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLER;
    }
    else if (ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLERDEBUG <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_PRO)
    {
        featrueKey = ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLERDEBUG;
    }
    else if (ARCONTROLLER_DICTIONARY_KEY_PRO <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_MINIDRONE)
    {
    ...
    else if (ARCONTROLLER_DICTIONARY_KEY_MINIDRONEDEBUG <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_COMMON)
    {
    ...
    else if (ARCONTROLLER_DICTIONARY_KEY_COMMONDEBUG <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_ARDRONE3)
    {
        featrueKey = ARCONTROLLER_DICTIONARY_KEY_COMMONDEBUG;
    }
    else if (ARCONTROLLER_DICTIONARY_KEY_ARDRONE3 <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_ARDRONE3DEBUG)
    {
